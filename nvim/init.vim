...
" ===
" split
map ds :set splitright<CR>:vsplit<CR>
map as :set nosplitright<CR>:vsplit<CR>
map ws :set nosplitbelow<CR>:vsplit<CR>
map xs :set splitbelow<CR>:vsplit<CR>
...
" :call mkdp#util#install_sync() or mkdp#util#install() in filename.md
